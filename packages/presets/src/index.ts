...
import { particlePresets, registerParticlePresets } from "./particle/index.js";
...
// The particle / fluid / 3D pack (particle systems, advected dye, point cloud).
...
registerParticlePresets(defaultPresetRegistry, { replace: true });
